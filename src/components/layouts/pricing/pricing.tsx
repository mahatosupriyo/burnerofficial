                            ...
                            <label className={styles.selectorcard}>
                                ...
                                <div className={styles.plandetails}>
                                    ...
                                    <div className={styles.price}>
                                        {/* <h4 className={styles.actual}><span style={{ fontWeight: 400 }}>₹</span> 6499</h4> */}
                                        <h2 className={styles.upfront}><span style={{ fontWeight: 400 }}>₹</span> 3999</h2>
                                        <p className={styles.monthly}><span style={{ fontWeight: 400 }}>₹</span> 333 per month</p>
                                    </div>
                                </div>
                            </label>
                            <label className={styles.selectorcard}>
                                ...
                                <div className={styles.plandetails}>
                                    ...
                                    <div className={styles.price}>
                                        ...
                                        <p className={styles.monthly}><span style={{ fontWeight: 400 }}>₹</span> 441 per month</p>
                                    </div>
                                </div>
                            </label>
                        </div>
